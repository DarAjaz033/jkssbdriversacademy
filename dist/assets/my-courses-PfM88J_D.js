import"./firebase-config-B4XEnROW.js";/* empty css               */import"./global-pdf-viewer-DNHCjlum.js";import{o as z}from"./auth-service-DMDvh9zM.js";import{f as E,g as L,b as T,d as k,e as C}from"./admin-service-Bd7EHEIN.js";class v{constructor(){this.currentUrl="",this.overlay=this.createOverlay(),document.body.appendChild(this.overlay),this.initPlyr()}static getInstance(){return v.instance||(v.instance=new v),v.instance}createOverlay(){const e=document.createElement("div");return e.className="vplayer-overlay",e.innerHTML=`
